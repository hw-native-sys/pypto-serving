...
def _pack_deepseek_v4_optional_attention(
    ...
    *,
    ...
    return {
        "hca_cmp_wkv": replicated_transposed(
            "attn.compressor.wkv.weight",
            (_DEEPSEEK_V4_HIDDEN_SIZE, _DEEPSEEK_V4_HCA_MAIN_OUT_DIM),
            torch.bfloat16,
            enabled=is_hca,
        ),
        "hca_cmp_wgate": replicated_transposed(
            "attn.compressor.wgate.weight",
            (_DEEPSEEK_V4_HIDDEN_SIZE, _DEEPSEEK_V4_HCA_MAIN_OUT_DIM),
            torch.bfloat16,
            enabled=is_hca,
        ...
        "csa_cmp_wkv": replicated_transposed(
            "attn.compressor.wkv.weight",
            (_DEEPSEEK_V4_HIDDEN_SIZE, _DEEPSEEK_V4_CSA_MAIN_OUT_DIM),
            torch.bfloat16,
            enabled=is_csa,
        ),
        "csa_cmp_wgate": replicated_transposed(
            "attn.compressor.wgate.weight",
            (_DEEPSEEK_V4_HIDDEN_SIZE, _DEEPSEEK_V4_CSA_MAIN_OUT_DIM),
            torch.bfloat16,
            enabled=is_csa,
        ...
        "csa_inner_wkv": replicated_transposed(
            "attn.indexer.compressor.wkv.weight",
            (_DEEPSEEK_V4_HIDDEN_SIZE, _DEEPSEEK_V4_CSA_INNER_OUT_DIM),
            torch.bfloat16,
            enabled=is_csa,
        ),
