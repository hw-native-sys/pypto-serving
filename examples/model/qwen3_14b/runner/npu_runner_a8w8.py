...
from examples.model.qwen3_14b.runner.npu_runner import Qwen314BModelRunner, _add_run_timing_args
...
class Qwen314BA8W8ModelRunner(ModelRunner):
    ...
    def init_kv_cache(self, model_id: str, config, runtime) -> None:
        """Create the runner-owned KV cache, plus INT8 scale pages for A8W8."""
        super().init_kv_cache(model_id, config, runtime)
