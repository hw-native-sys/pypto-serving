...
def qwen3_prefill_tq_host(
    ...
    block_table: pl.Tensor,
    slot_mapping: pl.Tensor,
    quant_k_cache: pl.Tensor,
    quant_v_cache: pl.Tensor,
    quant_k_scales: pl.Tensor,
    quant_v_scales: pl.Tensor,
    rot_matrices: pl.Tensor,
    tq_codebook: pl.Tensor,
    wo: pl.Tensor,
    post_rms_weight: pl.Tensor,
    w_gate: pl.Tensor,
    w_up: pl.Tensor,
