...
def unpack_nz(packed: torch.Tensor) -> torch.Tensor:
    ...
    The inverse of :func:`pack_nz`; tests use it to read packed slabs back logically.
    """
    rows, cols = packed.shape[-2:]
    c0 = _NZ_C0_BYTES // packed.element_size()
    blocked = packed.reshape(-1, cols // c0, rows // _NZ_FRACTAL_ROWS, _NZ_FRACTAL_ROWS, c0)
