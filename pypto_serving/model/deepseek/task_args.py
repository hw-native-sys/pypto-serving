...
def _decode_slot_specs(layout, hidden: int, vocab: int) -> dict[str, tuple[torch.dtype, tuple[int, ...]]]:
    ...
    return {
        ...
        "hca_compress_state_block_table": (torch.int32, (ranks, batch, layout.decode_hca_state_table_blocks)),
        "csa_compress_state_block_table": (torch.int32, (ranks, batch, layout.decode_csa_state_table_blocks)),
        "csa_inner_compress_state_block_table": (torch.int32, (ranks, batch, layout.decode_csa_inner_state_table_blocks)),
